...
type Props = { locationPermission: string } & NavigationInjectedProps
...
export const Weather = withNavigation(
    React.memo(({ locationPermission, navigation }: Props) => {
        const weatherForecast = useWeatherForecasts(locationPermission)
        ...
        return (
            <ForecastsView
                ...
                showSetLocationButton={locationPermission === RESULTS.DENIED}
                onSetLocationPress={() => {
